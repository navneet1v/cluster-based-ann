...
/**
 * Represents the cluster index structure for approximate nearest neighbor search. Contains
 * centroids, posting lists mapping centroids to vectors, and the original vectors.
 */
@Getter
public class ClusterIndex {
     ...
     */
    public ClusterIndex(
            final VectorStorage centroidStorage,
            final IntegerList[] postingsListArray,
    ...
    public void printClusterIndexStats() {
        ...
        if (minClusterSize != Integer.MAX_VALUE) {
            ...
            System.out.println(
                    "Avg cluster size: "
                            + (totalVectors / (postingsListArray.length - emptyClusters)));
        }
        System.out.println("=================================");
    }
}
