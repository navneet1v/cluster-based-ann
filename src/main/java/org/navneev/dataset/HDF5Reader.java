 ...
 *
 * <p>This class provides convenient methods to read numerical datasets commonly used in machine
 * learning and vector similarity search applications. It supports automatic type conversion between
 * double and float arrays, and handles common HDF5 file operations with proper resource management.
 *
 * <p>The class uses the jHDF library to interact with HDF5 files and automatically handles file
 * closing through try-with-resources statements.
 *
 * <h3>Supported Data Types:</h3>
 *
 * <ul>
 *   <li>2D float arrays for vector datasets
 *   <li>2D int arrays for ground truth neighbor indices
 *   <li>Automatic conversion from double to float precision
 * </ul>
 *
 * <h3>Usage Example:</h3>
 *
...
public class HDF5Reader {
     ...
     *
     * <p>This method reads numerical vector data from the specified dataset within the HDF5 file.
     * It supports both float and double precision datasets, automatically converting double arrays
     * to float arrays when necessary.
     *
     ...
     * @throws RuntimeException if the file cannot be read, dataset is not found, or data type is
     *     unsupported
     ...
     *
     * <p>This method is typically used to read ground truth neighbor indices for evaluation of
     * nearest neighbor search algorithms. The dataset should contain integer arrays where each row
     * represents the true nearest neighbors for a query.
     *
     * @param filePath the path to the HDF5 file
     ...
     *
     * <p>This utility method displays the file path and lists all available datasets with their
     * dimensions. This is useful for exploring the structure of an HDF5 file before reading
     * specific datasets.
     *
     * <p>Output format:
     *
